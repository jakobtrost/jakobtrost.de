...
<head>
	...
	<meta property="og:description" content="Jakob Trost | CTO @ GREYD - Web Developer & UI-Designer">
	...
	<meta name="description" content="Jakob Trost | CTO @ GREYD - Web Developer & UI-Designer">
	<meta name="keywords" content="Developer, Web Developer, Javascript, Full-Stack Web, Web Design, UX, UI, CTO">
	...
	<!-- Structured Data for better accessibility and SEO -->
	<script type="application/ld+json">
	{
		...
		"description": "CTO @ GREYD",
		"email": "hello@jakobtrost.de",
		"telephone": "+4915751061976",
		"url": "https://www.jakobtrost.de",
		"sameAs": [
			"https://www.linkedin.com/in/jakobtrost/"
		],
		"knowsLanguage": "en",
		"knowsAbout": ["Web Development", "UI Design", "JavaScript", "Full-Stack Development"]
	}
	</script>
</head>
<!--yyyyyyyyyyNmo.                      
...
<body data-colorscheme="<?php echo $selected_colorscheme['slug']; ?>">
		...
		<div class="card" role="region" aria-labelledby="title">
			...
			<div class="card--inner">
				<div class="card--inner-bottom">
					...
					<h2 id="description">CTO @ <a href="https://greyd.io" target="_blank" rel="noopener noreferrer" aria-label="Visit GREYD (opens in new tab)">GREYD</a></h2>
				</div>
				<div id="actions" class="card--inner-top" role="navigation" aria-label="Contact Information">
					...
					<a href="tel:+4915751061976" aria-label="Call 01575 1061976">01575 1061976</a><br>
					<a href="https://www.linkedin.com/in/jakobtrost/" target="_blank" rel="noopener noreferrer" aria-label="Visit my LinkedIn profile (opens in new tab)">LinkedIn</a><br>
				</div>
				<div id="logo" class="card--inner-middle">
					...
					>
						<title id="logoTitle">Jakob Trost Logo</title>
						<desc id="logoDesc">A monogram logo with intertwined J and T letters. The J curves gracefully to the right, while the T features a distinctive folded design creating a 3D effect. Both letters use clean, bold typography.</desc>
	...
	<!-- Color scheme selector with improved accessibility -->
	<fieldset role="group" aria-labelledby="colorscheme-legend">
		<legend id="colorscheme-legend" class="visually-hidden">Select Color Scheme</legend>
		<?php
		foreach ( $colorschemes as $colorscheme ) {
			echo sprintf(
				'<input type="radio" name="colorscheme" value="%1$s" id="%1$s" %3$s data-color="%4$s" aria-describedby="%1$s-desc">'.
				'<label for="%1$s" aria-label="%2$s"><span class="visually-hidden">%2$s</span></label>',
				$colorscheme[ 'slug' ],
				$colorscheme[ 'title' ],
